	...
	<center>
	 <div id="Middle">
		...
		<div id="Leftcol">
			...
			<div id="Image1"><img src="Images/donation.jpg"  style="border-radius:20px;"></img></div>
		...
		<div id="Content">		
			<h1>Prasad And Bhojan Donation</h1><hr>
		...
		<tr><td>
		&nbsp;Amount:</td><td><input type="text" name="amt" value="--"  required onkeypress="return onlyNos(event,this);"><br>(*Min amt Rs.10,000 & Max amt Rs.3,00,000)</td></tr><br>
		<tr><td>
		&nbsp;Remark Here:</td><td><textarea rows="1" cols="30" name="remark"></textarea></td></tr><br>
		<tr><td>
		<br><br><br>
		...
		<div id="Rightcol">
			...
			<div id="Image3"><img src="Images/donation.png"  style="border-radius:20px;"></img></div>
...
<?php
	...
	if(isset($_POST['Submit']))
	{
		...
		$query_insert="INSERT INTO `bhojan`( `amt`, `remark`)values($amt,'$remark')";
