...
<body id="b1">
	...
	<center>
	 <div id="Middle">
		...
		<div id="Content">
		<h2 style="font-family:Lucida Handwriting;">Location</h2><hr>
			<img src="Images/mapshirdi.gif" style="border-radius:20px; border:solid;border-color:gray"></img><br>
			<p align="left">When Shirdi was a very small village Saibaba predicted that millions of people will flock like ants at Shirdi in future and now one finds that Saibaba's prophecy has come to be true and a small village has become the prominent holy place of Universal Religion of Love.Shirdi town is situated in Rahata Tahasil in Ahmednagar District of Maharashtra state(India).It falls on Ahmednagar-Manmad state highway no.10 at 83 km. from Ahmednagar, and  15 km. from Kopargaon.It(the Ahmednagar-Manmad road) was a very busy route in the old times.It is located at 185km. to the east from western seashore line.</p>
		</div>
		...
		<center>
		<div id="Footer1">
		  <marquee direction="left"  onmouseover="this.stop();" onmouseout="this.start();" scrolldelay="0" scrollamount="4" style="margin:0 10px 0 10px;">||Shri Sai Devotees are requested to note that Camera, Video Camera, Handicams, Mobiles, Ladies Purse, Handbags are not allowed in  Temple and Temple Premises|| </marquee>		
		</div>		
		<div id="Footer">
