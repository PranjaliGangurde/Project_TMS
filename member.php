	...
	<center>
	 <div id="Middle">
		...
		<div id="Leftcol">
			...
			<Marquee direction="down" onmouseover="this.stop();" onmouseout="this.start();" scrolldelay="0" scrollamount="4" style="margin:0 15px 0 15px;">
		...
		<div id="Content">
		<table id="sample">		
			<h1>Life Membership Form</h1><hr>
			<table id="tab">
			<tr><td>
		<form name="form1" method="post" onSubmit="return validate(this.form1)">
		
		
		&nbsp;First Name:</td><td><input type="text" name="fname" onkeypress="return onlyAlphabets(event,this);"> <span style="color:red">*Enter The Name</span></td></tr><br>
		<tr><td>
		&nbsp;Last Name:</td><td><input type="text" name="lname" onkeypress="return onlyAlphabets(event,this);"> <span style="color:red"><span style="color:red">*Enter The Last Name</span></tr></td><br>
		<tr><td>
		&nbsp;Address:</td><td><textarea rows="2" cols="20" name="address"></textarea></td></tr><br>
		<tr><td>
		&nbsp;Gender:</td><td><input type="radio" name="gender" value="Male" >Male&nbsp;&nbsp;<input type="radio" name="gender" value="Female">Female</td></tr><br>
		<tr><td>
		&nbsp;Contact No:</td><td><input type="text" name="cntno" onkeypress="return onlyNos(event,this);"></td></tr><br>
		<tr><td>
		&nbsp;Email Id:</td><td><input type="text" name="email"></td></tr><br>
		<tr><td>
		&nbsp;User Name:</td><td><input type="text" name="uname"  required></td></tr><br>
		<tr><td>
		&nbsp;Password:</td><td><input type="password" name="paswrd"  required></td></tr><br>  						
		<tr><td>
				<br><br><br>
				</td><td><input type="submit" value="Register" name="Register" onClick="validate(form1)">
...
<?php
	...
	if(isset($_POST['Register']))
	{
		...
		$query_insert="INSERT INTO `member`( `fname`, `lname`, `address`, `gender`, `cntno`, `email`, `uname`, `paswrd`)values('$fname','$lname','$address','$gender','$cntno','$email','$uname','$paswrd')";
		$query=mysqli_query($conn,$query_insert);
		if($query)
		{
			$message = "You are succefully Register Here...Welcome";
