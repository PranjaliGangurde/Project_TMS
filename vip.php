	...
	<center>
	 <div id="Middle">
		...
		<div id="Leftcol">
			...
			<div id="Image1"><img src="Images/vip.jpg"  style="border-radius:20px;"></img></div>
		...
		<div id="Content">		
			<h1>VIP Pass Booking</h1><hr>
			<table id="tab">
	  <tr><td>
		<form name="frm" method="post" action="">
		  
			Darshan:</td><td><select name="Darshan">
                    <option>--select--</option>
					<option value="Aarti">Aarti</option>
					<option value="Darshan">Mukh Darshan</option>
                   
                    </select></td></tr><br>
			 <tr><td>
			 Date:</td><td><input type="text" id="datepicker" name="date" value="" />  </td></tr><br>
				<tr><td>
				No.Of Male:</td><td><input type:"text" name="male" value="--" onkeypress="return onlyNos(event,this);">*Adult<br>(500rs per person)</td></tr><br>
				<tr><td>
				No.Of.Female:</td><td><input type="text" name="female" value="--" onkeypress="return onlyNos(event,this);">*Adult <br>(500rs per person)</td></tr><br>
				<tr><td>
                NO.Of. Childrens:</td><td><input type="text" name="child" value="--" onkeypress="return onlyNos(event,this);">(*Age Limit 12 years)<br>
												(Max 4 Childrens Allowed per pass)<br>(100rs per children)</td></tr><br>
				<tr><td>
				Charges Per Pass:</td><td><input type="text" name="charge" value="--" onkeypress="return onlyNos(event,this);"></td></tr><br><br>
				<tr><td>
				<br><br><br>
				</td><td><input type="submit" value="Confirm" name="Submit">
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Cancel" onClick="location:Index.php"><br></tr></td><br>
		...
		<div id="Rightcol">
			...
			<div id="Image3"><img src="Images/vip1.jpg"  style="border-radius:20px;"></img></div>
		...
		<div id="Footer">
			...
			<a href="#">DONATION</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#">FEEDBACK</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<br><font color="blue">CopyRight@D.M.I. All Rights Resereved</font>	
		</div>
		</center>
	</div>
</body>
...
$select1=$_POST['Darshan'];
		...
		$query_insert="INSERT INTO `vip`(`darshan`, `male`, `female`, `child`, `charge`)values('$select1',$male,$female,$child,$charge)";
		$query=mysqli_query($conn,$query_insert);
		if($query)
		{
			$message = "You are succefully Book your Pass Here...Welcome";
