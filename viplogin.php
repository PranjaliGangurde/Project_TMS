...
<body id="b1">
			...
			<ul style="align:center">
				...
				<li><a href="#">REGISTRATION</a>
				    <ul>
				      ...
				      <li><a href="vip.php">VIP PASS BOOKING</a></li>
				    </ul>
				</li>
				<li><a href="book.php">BOOKS COLLECTION</a>
				<li><a href="#">DONATION</a>
					<ul>
						<li><a href="fund.php">FUND DONATION</a></li>
	...
	<center>
	 <div id="Middle">
		...
		<div id="Leftcol">
			...
			<div id="Image1"><img src="Images/login.jpg"  style="border-radius:20px;"></img></div>
	...
	if(isset($_POST['btn_login']))
	{
		...
		$query_login=mysqli_query($conn,"SELECT * FROM `member` WHERE `uname`='$user_email' and `paswrd`='$user_password'");
		...
		if(mysqli_num_rows($query_login)==1)
		{
			...
			if($user_email==$row['uname'] && $user_password==$row['paswrd'])
			{
...
?>
                ...
                <tr>
                	<td colspan="4" align="center">
                    	<input type="submit" value="Login" name="btn_login" onClick="location:('member.php')">
						<input type="reset" value="Cancel" name="reset" onClick="location=('index.php')">
                    </td>
                </tr>
		</form>
		<br>
		<span style="color:red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;New User ???</span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="member.php">Click Here For Registration</a><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(* This Fields Are Mendatory)
		</table>
		</div>

		<div id="Rightcol">
			<div style="font-family:Lucida Handwriting;font-size:13px">Login</div>
			<div id="Image3"><img src="Images/login_icon.jpg"  style="border-radius:20px;"></img></div>
